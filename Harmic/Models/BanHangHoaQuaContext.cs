...
public partial class BanHangHoaQuaContext : DbContext
{
    public BanHangHoaQuaContext()
    {
    }

    public BanHangHoaQuaContext(DbContextOptions<BanHangHoaQuaContext> options)
        : base(options)
    {
    }
